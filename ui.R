...
shinyUI(fluidPage(
	navbarPage("Coursera Developing Data Products by Zhongda"
			),
	titlePanel("Coursera Project from Kaggle competition Challenge"),
	sidebarLayout(
	# sidebarPanel(
	mainPanel(
		h3('Tweek the Plot'),
...
sidebarPanel(
		...
		p("you want the realtionships between?"),
